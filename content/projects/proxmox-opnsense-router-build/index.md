...
{{< alert "warning" >}}
**Building this today?** The biggest price swings are in RAM (+$96) and the SSD (+$199). The Crucial P3 is a Gen3 NVMe, and now that Gen4 drives dominate the market, Gen3 stock has thinned out and prices have climbed. The N100M's M.2 slot runs at Gen3x2 speeds regardless of drive generation, so a Gen4 1TB NVMe (~$136 currently) is the smarter buy for a new build: same speed at the slot, lower price.
{{< /alert >}}
